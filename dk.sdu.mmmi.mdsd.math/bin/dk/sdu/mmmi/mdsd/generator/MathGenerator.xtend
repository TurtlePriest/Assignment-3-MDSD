...
class MathGenerator extends AbstractGenerator {
	...
	def void generateFile(MathExp math, IFileSystemAccess2 fsa) {
		fsa.generateFile("math_expression/"+math.name+".java", math.generateEntity)
	}
	
	def CharSequence generateEntity(MathExp exp) '''
